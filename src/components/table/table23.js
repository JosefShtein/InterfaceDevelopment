...
import data from './jsons/sheets12.json';
import './table2.css';
...
class RectangleGrid extends React.Component {
    ...
    renderRectangles() {
        ...
        for (let i = 0; i < 12; i++) {
            ...
            let one = this.elementsArray[0]; //1
            let two = this.elementsArray[6];
            let three = this.elementsArray[1];
            let four = this.elementsArray[2];
            ...
            rectangles.push(
                <div key={i} style={{ display: 'inline-block', margin: '5px', position: 'relative',  left:'0px'}}>
                    ...
                    {one == i && <div style={{position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)' }}><img src={require('./imOrPov4.png')}/>
