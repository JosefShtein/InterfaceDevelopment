...
import data from './jsons/sheets8.json';
import './table2.css';
        ...
        for (let i = 0; i < 12; i++) {
            ...
            rectangles.push(
                <div key={i} style={{ display: 'inline-block', margin: '5px', position: 'relative',  left:'0px'}}>
                    ...
                    {four == i && <div style={{position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)' }}><img src={require('./imOrPov3.png')}/>
